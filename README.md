...
Through the first two weeks of the internship, I have developed practical experience in:
...
These assignments have helped me build a stronger foundation for progressing toward more advanced **Data Analytics and Data Science workflows**.
...
My goal is to continuously strengthen my practical skills in:

**Python → Data Analysis → SQL → Visualization → Business Insights**
...
The internship assignments provide practical exposure to data analytics concepts and help develop hands-on problem-solving and analytical skills.
...
⭐ **This repository is maintained as a record of my learning and progress throughout the InternNova Data Analytics Internship.**
